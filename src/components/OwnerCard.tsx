...
// const OwnerCard: React.FC<OwnerCardProps> = ({ nom, tel, email, type, onPrendre }) => {
//   return (
//     <div className="border p-6 rounded shadow-sm bg-gray-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
//       <div className="flex items-center gap-4">
//         {/* <img
//           src={avatar || '/avatars/default-user.png'}
//           alt={nom}
...
//           <p className="text-sm text-gray-600">{type === 'agent' ? 'Agent immobilier' : 'Propriétaire particulier'}</p>
//           {/* {agence && <p className="text-xs text-gray-500 italic">{agence}</p>} */}
