...
// import { FaBed, FaRulerCombined, FaShower } from 'react-icons/fa'
// import { t } from 'i18next'
// import DateSejourPicker from '../../components/DateSejourPicker'
...
//   // Trouver l’annonce à partir de l’ID dans l’URL
//   const a = AnnoncesMock.find((annonce) => annonce.id === Number(id))

//   // Gère l'affichage de la modale de RDV
//   const [showRdv, setShowRdv] = useState(false)

//   const [datesSejour, setDatesSejour] = useState({ startDate: null, endDate: null })

//   // Si aucune annonce ne correspond, afficher un message
//   if (!a) {
//     return (
//       <div className="mt-24 px-4">
//         <div className="bg-red-100 text-red-700 p-4 rounded text-center shadow">
...
//   // Vérifie si un propriétaire est défini pour cette annonce
...
//         {a.type?.toLowerCase() === 'meublé' && (
//   <DateSejourPicker onChange={setDatesSejour} />
// )}
...
//           tel={proprietaire.tel}
//           email={proprietaire.email}
//           // agence={proprietaire.agence}
//           type={proprietaire?.type}
//           // avatar={proprietaire?.avatar}
//           onPrendre={() => setShowRdv(true)}
//           isMeuble={a.type === 'Meublé'}
//             onChangeDates={setDatesSejour}
//         />
//       </div>

//       {/* Modale de prise de RDV */}
//       <RdvModal
//         isOpen={showRdv}
//         onClose={() => setShowRdv(false)}
//         proprietaireNom={proprietaire.nom}
